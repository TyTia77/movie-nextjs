...
import { TopratedMovieType } from "./api";
import Link from "next/link";

type cardMovieType = cardType & {
  item: TopratedMovieType;
};

export default WithCard(function (props: cardMovieType) {
  // const GAP = 16;
  const { item, itemWidth, visible = 0, i } = props;
